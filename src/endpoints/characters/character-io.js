...
import { deepMerge, humanizedDateTime, tryParse, getConfigValue } from '../../util.js';
...
export async function writeCharacterData(inputFile, data, outputFile, request, crop = undefined) {
    try {
        // Reset the cache
