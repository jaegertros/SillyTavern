...
import { characters, chat, chat_metadata, create_save, extension_prompts, main_api, max_context, menu_type, name1, name2, online_status, streamingProcessor, this_chid, swipeState } from './core/state.js';
...
import { activateSendButtons, addOneMessage, appendMediaToMessage, callPopup, deactivateSendButtons, extractMessageFromData, Generate, generateQuietPrompt, getCharacters, getCurrentChatId, openCharacterChat, reloadCurrentChat, renameChat, saveChatConditional, saveMetadata, saveReply, selectCharacterById, sendGenerationRequest, sendStreamingRequest, setExtensionPrompt, stopGeneration, substituteParams, substituteParamsExtended, updateChatMetadata, updateMessageBlock, printMessages, clearChat, unshallowCharacter, deleteLastMessage, getCharacterCardFields, swipe_right, swipe_left, generateRaw, showSwipeButtons, hideSwipeButtons, deleteMessage, refreshSwipeButtons, swipe, isSwipingAllowed, ensureMessageMediaIsArray, getMediaDisplay, getMediaIndex, scrollChatToBottom, scrollOnMediaLoad, getOneCharacter, getCharacterSource } from '../script.js';
import {
    extension_settings,
    ModuleWorkerWrapper,
